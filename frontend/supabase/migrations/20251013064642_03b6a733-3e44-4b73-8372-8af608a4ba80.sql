-- Update submit_quiz to handle short answer questions separately
-- Short answer questions won't affect the grade until instructor reviews them
...
BEGIN
  ...
  -- Server-side grade calculation - only for multiple choice questions
  -- Short answer questions are marked for manual review
  ...
  -- If there are short answer questions, grade is null (pending review)
  IF v_has_short_answer THEN
  ...
  RETURN jsonb_build_object(
    ...
    'pending_review', v_has_short_answer
  );
END;
$function$;