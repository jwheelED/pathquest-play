        ...
        <Card className="mb-8">
          <CardContent className="pt-6">
            <p className="text-muted-foreground leading-relaxed">
              Edvana ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our AI-powered educational technology platform. Please read this policy carefully to understand our practices regarding your personal data.
            </p>
          </CardContent>
        </Card>
        ...
        <Accordion type="single" collapsible className="space-y-4">
          <AccordionItem value="information-collected" className="border rounded-lg px-4">
            ...
            <AccordionContent className="text-muted-foreground space-y-4 pb-4">
              <div>
                ...
                <p>When you create an account, we collect your name, email address, and role (student, instructor, or administrator). If you sign up through your institution, we may also collect your organizational affiliation.</p>
              </div>
              <div>
                <h4 className="font-medium text-foreground mb-2">Educational Content</h4>
                <p>We collect and process lecture transcriptions, study materials you upload, answer keys (for instructors), and any content you create or submit through the platform.</p>
              </div>
              <div>
                <h4 className="font-medium text-foreground mb-2">Learning Analytics</h4>
                <p>We track your responses to questions, performance metrics, confidence levels, time spent on activities, and learning progress to personalize your experience and provide insights.</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p>To support academic integrity, we may collect behavioral data such as tab switching patterns, typing behavior, and copy-paste activity during assessments. This data is used solely to provide transparency to instructors and is not used to automatically penalize students.</p>
              </div>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="information-sharing" className="border rounded-lg px-4">
            ...
            <AccordionContent className="text-muted-foreground space-y-4 pb-4">
              <div>
                ...
                <p>If you are a student, your instructors can view your performance data, responses, and engagement metrics for their classes.</p>
              </div>
              <div>
                <h4 className="font-medium text-foreground mb-2">With Institutional Administrators</h4>
                <p>If your institution uses Edvana, administrators may have access to aggregate metrics and usage data for their organization.</p>
              </div>
              <div>
                <h4 className="font-medium text-foreground mb-2">Service Providers</h4>
                <p>We work with trusted third-party service providers for AI processing (including transcription and question generation), cloud hosting, and analytics. These providers are contractually obligated to protect your data.</p>
              </div>
              <div>
                <h4 className="font-medium text-foreground mb-2">Legal Requirements</h4>
                <p>We may disclose your information if required by law, court order, or to protect the rights, property, or safety of Edvana, our users, or others.</p>
              </div>
              <div>
          ...
          <AccordionItem value="data-security" className="border rounded-lg px-4">
            ...
            <AccordionContent className="text-muted-foreground space-y-4 pb-4">
              ...
              <p className="mt-4">While we strive to protect your information, no method of transmission over the Internet is 100% secure. We encourage you to use strong passwords and protect your account credentials.</p>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="your-rights" className="border rounded-lg px-4">
            ...
            <AccordionContent className="text-muted-foreground space-y-4 pb-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li><strong>Opt-out:</strong> Opt out of certain data collection features</li>
              </ul>
              <p className="mt-4">To exercise these rights, please contact us at privacy@edvana.io. We will respond to your request within 30 days.</p>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="educational-privacy" className="border rounded-lg px-4">
            ...
            <AccordionContent className="text-muted-foreground space-y-4 pb-4">
              <div>
                ...
                <p>For users at U.S. educational institutions, we comply with the Family Educational Rights and Privacy Act (FERPA). Educational records are protected and only shared as permitted under FERPA.</p>
              </div>
              <div>
                <h4 className="font-medium text-foreground mb-2">COPPA</h4>
                <p>Edvana is designed for higher education and is not intended for children under 13. We do not knowingly collect personal information from children under 13. If you believe we have inadvertently collected such information, please contact us immediately.</p>
              </div>
              <div>
                <h4 className="font-medium text-foreground mb-2">International Users</h4>
                <p>If you are accessing Edvana from outside the United States, please be aware that your data may be transferred to and processed in the United States. By using our service, you consent to this transfer.</p>
              </div>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="data-retention" className="border rounded-lg px-4">
            ...
            <AccordionContent className="text-muted-foreground space-y-4 pb-4">
              <p>We retain your personal data for as long as your account is active or as needed to provide you with our services. If you delete your account, we will delete or anonymize your personal data within 90 days, except where we are required to retain it for legal or legitimate business purposes.</p>
              <p>Aggregated, anonymized data that cannot identify you may be retained indefinitely for research and platform improvement purposes.</p>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="cookies" className="border rounded-lg px-4">
            ...
            <AccordionContent className="text-muted-foreground space-y-4 pb-4">
              ...
              <p className="mt-4">You can control cookies through your browser settings, but disabling cookies may affect your ability to use certain features of our platform.</p>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="changes" className="border rounded-lg px-4">
            ...
            <AccordionContent className="text-muted-foreground space-y-4 pb-4">
              <p>We may update this Privacy Policy from time to time. We will notify you of material changes by posting the updated policy on our platform and updating the "Last updated" date. Your continued use of Edvana after such changes constitutes your acceptance of the updated policy.</p>
            </AccordionContent>
          </AccordionItem>
