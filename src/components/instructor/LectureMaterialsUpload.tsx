        ...
        .then(async (result) => {
          if (result.data?.text) {
            await supabase
              ...
              .eq("id", material.id);
            queryClient.invalidateQueries({ queryKey: ["lecture-materials"] });
            console.log("✅ Auto-parsed on load:", material.title, result.data.chars, "chars");
          }
        })
      ...
      <CardContent className="space-y-6">
        <div className="space-y-4">
          ...
          <Button
            ...
            disabled={!selectedFile || !title.trim() || uploading || isDeleting}
            className="w-full"
          >
            {uploading ? (
              <>
