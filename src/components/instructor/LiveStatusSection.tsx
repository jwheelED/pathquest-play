...
export function LiveStatusSection({ onStartLive, onViewSummary }: LiveStatusSectionProps) {
  return (
    <div className="command-card p-5 lg:p-6 h-full flex flex-col">
      ...
      {/* Body */}
      <p className="text-sm text-charcoal-muted leading-relaxed mb-5 flex-1">
      ...
      <div className="flex flex-wrap items-center gap-2.5">
        <Button 
          onClick={onStartLive}
          className={cn(
            "rounded-full px-5 h-9 gap-2 font-medium text-sm",
        ...
        <Button 
          ...
          className={cn(
            "rounded-full px-4 h-9 gap-2 font-medium text-sm",
