...
-- Fix update_assignment_grade: Add instructor ownership check
CREATE OR REPLACE FUNCTION public.update_assignment_grade(p_assignment_id uuid, p_short_answer_grades jsonb DEFAULT NULL::jsonb)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
